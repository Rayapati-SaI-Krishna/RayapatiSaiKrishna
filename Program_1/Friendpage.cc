...
#include<regex>
using namespace std;
class Friendpage  //Class Declaration
{
  private: //Private Varibales
  string s_username;
  string s_emailid;
  public:
  string name;
  
  multimap<string, string> my;//// empty multimap container
  multimap<string, string>::iterator itr;
  Friendpage()//constructor
  {
     ...
     regex input("(\\w+)(\\.|_)?(\\w*)@(\\w+)(\\.(\\w+))+");
        for (itr = my.begin(); itr != my.end(); ++itr)
        {
             cout << "Enter the Username to edit Details"<< endl;
                cin >> name;
                itr = my.find(name);//find function
                edit:
                if (itr != my.end())
                {
                   ...
                   my.erase(name);//// function to erase 
                   my.insert(pair<string, string>(name,s_emailid));
                   }
                   else
                   {
...
void Friendpage::search_user()
{
                ...
                for (itr = my.begin(); itr == my.end(); ++itr)
                {
                    cout<<"There are nothing to search.First Enter the user Details"<<endl;
                    break;
                }
